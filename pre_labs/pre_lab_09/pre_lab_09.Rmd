...
https://www.datawrapper.de/_/IA3tJ/
...
**Task** Write code to add columns showing the total number of votes for each county and the percentage of votes received by Wes Moore in each county (you did this in another lab), then replace the CSV file in the data folder with it.
...
md_gov_county <- md_gov_county |>
  ...
  mutate(percent_votes_moore = (moore/total_votes)*100)
...
This didn't apply to us because we set the map as just Maryland by county from the beginning.
...
Now when you hover over a county you see the county's name and a nice rounded percentage of the votes Moore won.
...
https://www.datawrapper.de/_/c88Qz/
